...
public class CollectionModifyTest extends BaseCollectionTestCase {
    ...
    public void testMergePatch() throws Exception {
        ...
        this.collection.add("{\"_id\": \"1\", \"name\": \"Alice\", \"address\": {\"zip\": \"12345\", \"street\": \"32 MaeFilho str\"}}").execute();
        ...
        assertEquals(JsonParser.parseDoc("{\"_id\": \"1\", \"name\": \"Joe\", \"address\": {\"zip\": \"91234\", \"street\": \"32 MaeFilho str\"}}").toString(),
                docs.next().toString());
        assertTrue(docs.hasNext());
