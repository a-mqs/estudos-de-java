...
public class ComportamentosParametrizadosSimplificado {
    public static void main(String[] args) {
        ...
        // carros verdes"
        /**
         * E pra simplificar ainda mais, podemos fazer do mesmo jeito
         * que fazemos com o Runnable, por classes anônimas:
         */
